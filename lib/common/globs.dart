...
class SVKey {
  ...
  // ❗ Forgot password Flutter tarafda bor – backendda yo‘q
  // Shuning uchun vaqtinchalik dummy qilib qo’yaman
...
class KKey {
  ...
  // ❗ Flutter forgot password sahifalari kutayotgani uchun
